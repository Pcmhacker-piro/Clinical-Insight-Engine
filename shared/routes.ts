import { z } from "zod";
import { insertAssessmentSchema, assessmentResponseSchema, createAssessmentResponseSchema } from "./schema";
...
export const api = {
  assessments: {
    create: {
      ...
      responses: {
        201: createAssessmentResponseSchema,
    ...
    list: {
      ...
      path: "/api/assessments" as const,
      responses: {
        200: z.array(assessmentResponseSchema),
      },
    },
  },
};
